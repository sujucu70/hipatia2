...
- `frases_cuenta.frases`:
  ...
  - «Por el piloto que no escala» · «si han probado IA» · «El 95% de los pilotos de IA no consigue el retorno esperado. Los que lo consiguen tienen un proceso ordenado y RPA por debajo. Empezamos por ahí, y el agente va encima solo donde el proceso exige decidir.»
...
2. Dolor «Metimos IA y no ha pasado nada. No escala.» · frase «El 95% de los pilotos de IA no consigue el retorno esperado; los que lo consiguen tienen RPA rodado debajo.» · prueba «UNED: 95 procesos levantados, 26 robots en producción en seis meses.» · paso «Empezamos por el proceso ordenado; el agente va encima donde decide.»
